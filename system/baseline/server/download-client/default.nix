{
  systemd.tmpfiles.rules = [
    ...
    "d /export/media/torrents/complete/shows 0770 deluge media"
    "d /export/media/torrents/complete/shows-anime 0770 deluge media"
    "d /export/media/torrents/complete/movies 0770 deluge media"
    "d /export/media/torrents/complete/movies-anime 0770 deluge media"
